...
public class PPEAdaptorTasks extends FirestoreRecyclerAdapter<Equipment, PPEAdaptorTasks.ViewHolder> {


    public PPEAdaptorTasks(@NonNull FirestoreRecyclerOptions<Equipment> options) {
