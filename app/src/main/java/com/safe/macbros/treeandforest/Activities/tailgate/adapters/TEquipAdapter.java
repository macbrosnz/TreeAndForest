...
public class TEquipAdapter extends FirestoreRecyclerAdapter<EquipmentTailgate, TEquipAdapter.ViewHolder> {
    private static final String TAG = "TEquipAdapter";
    //test
    ...
    public TEquipAdapter(@NonNull FirestoreRecyclerOptions<EquipmentTailgate> options, HashMap<String, Object> message) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull final TEquipAdapter.ViewHolder holder, int position, @NonNull final EquipmentTailgate model) {
        ...
        holder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (holder.checkBox.isChecked()) {
                    ...
                    updateFirestore(model.getTailgateId(), model.getStaffId(), model.getId(), true);


                } else {

                    updateFirestore(model.getTailgateId(), model.getStaffId(), model.getId(), false);
        ...
        holder.title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (model.getNoteId() != null || model.getAlertId() != null) {
    ...
    @NonNull
    @Override
    public TEquipAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new TEquipAdapter.ViewHolder(v);
