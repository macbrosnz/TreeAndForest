...
public class DriverHours extends DialogFragment {
    private static final String TAG = "DriverHours";
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton("Next", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        meth.sendDialogMessage(new WorkHours(), WorkHours.getTAG(), message);
    ...
    public void updateDriver() {
        ...
        DocumentReference dr = db.collection("drivers").document();
        driver.setId(dr.getId());
